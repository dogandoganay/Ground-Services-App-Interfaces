...
"\norientation:"+b.sPdfOrientation+"\nsize:"+b.sPdfSize+"\n--/TableToolsOpts--\n"+this.fnGetTableData(b))}}),print:e.extend({},TableTools.buttonBase,{sInfo:"<h6>Yazdirma gorunumu</h6><p>Lutfen tabloyu yazdirmak icin tarayicinizin yazdirma fonksiyonunu (CTRL + P) kullanin. </p>",sMessage:null,bShowAll:!0,sToolTip:"Yazdirma gorunumune gozat",sButtonClass:"DTTT_button_print",sButtonText:"Print",fnClick:function(a,b){this.fnPrint(!0,b)}}),text:e.extend({},TableTools.buttonBase),select:e.extend({},TableTools.buttonBase,
